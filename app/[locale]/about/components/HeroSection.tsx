      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between h-full relative z-10">
        ...
        <div className="flex-1 flex flex-col justify-center items-center lg:items-start lg:pr-8 xl:pr-12 text-center lg:text-left order-2 lg:order-1 mt-6 lg:mt-0">
          <div className="w-full max-w-2xl">
            <h1 className="text-[#F9461C] text-[40px] sm:text-[48px] md:text-[60px] lg:text-[66px] xl:text-[72px] font-extrabold mb-4 sm:mb-6 md:mb-8 leading-tight whitespace-pre-line">
              {t('title')}
            </h1>
        ...
        <div className="flex-1 flex justify-center items-center relative order-1 lg:order-2 w-full lg:pl-4 xl:pl-8">
          <div className="relative w-full flex justify-center">
            <Image 
              ...
              width={1000} 
              height={1000} 
              className="object-contain w-96 h-96 sm:w-[450px] sm:h-[450px] md:w-[550px] md:h-[550px] lg:w-[650px] lg:h-[650px] xl:w-[750px] xl:h-[750px] 2xl:w-[850px] 2xl:h-[850px] drop-shadow-lg"
              priority
              sizes="(max-width: 640px) 384px, (max-width: 768px) 450px, (max-width: 1024px) 550px, (max-width: 1280px) 650px, (max-width: 1536px) 750px, 850px"
            />
          </div>
        </div>
