    ...
    <>
      ...
      >
        <div className="flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 relative z-10">
          <div className="flex items-center justify-center w-logofull">
      ...
      {/* Mobile Navigation */}
      <nav className="fixed md:hidden bg-white top-0 left-0 right-0 z-50 px-4 py-2 flex items-center justify-between">
        {/* Hamburger Menu (Left) */}
        <button
      ...
      >
        ...
        <div className="mt-auto px-6 pb-6">
          <div>
            ...
            <div className="flex space-x-4 text-[#F9461C] mt-6">
              {/* Social Icons at Top */}
              ...
              <div className="flex space-x-4 text-[#F9461C]">
                ...
                <a
                  ...
                  aria-label="Facebook"
                  className="w-8 h-8 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-[#F9461C] hover:text-white transition-all duration-300 hover:scale-110 shadow-md border border-[#F9461C]/20"
                >
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
                ...
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/nagabalm"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Instagram"
                  className="w-8 h-8 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-gradient-to-r hover:from-[#F56565] hover:to-[#C53030] hover:text-white transition-all duration-300 hover:scale-110 shadow-md border border-[#F9461C]/20"
                >
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Telegram"
                  className="w-8 h-8 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-[#0088cc] hover:text-white transition-all duration-300 hover:scale-110 shadow-md border border-[#F9461C]/20"
                >
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
