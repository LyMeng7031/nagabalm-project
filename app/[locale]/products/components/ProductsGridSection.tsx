        ...
        <div className="flex flex-col lg:flex-row p-4 sm:p-6 lg:p-8 gap-4 sm:gap-6 lg:gap-8 overflow-y-auto max-h-[90vh]">
          <div className="flex-1 flex justify-center items-center bg-gray-50 rounded-xl p-4 sm:p-6">
            <div className="relative w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80">
              <Image
                src={product.images?.[0] || "/placeholder-logo.png"}
                alt={tr.name || product.slug}
                fill
...
const ProductsGrid: React.FC = () => {
  ...
  const productsToDisplay = useMemo(() => {
    ...
    // Map to the display format and add sorting if needed
    // You can add a custom sort order here if the API doesn't provide one
    return result.map((p) => {
    ...
    >
      ...
      <div className="w-full max-w-7xl flex flex-col items-center mb-6 sm:mb-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full mb-8 sm:mb-12 space-y-4 sm:space-y-6">
          ...
          <div className="flex justify-center">
            <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 bg-gray-50 p-2 rounded-2xl sm:rounded-full border border-gray-200 overflow-x-auto">
              <button
            ...
            <div className="text-gray-600 text-sm">
              {searchQuery ? (
                <span>
                  ...
                  {t("products.grid.results.resultsFor")} "
